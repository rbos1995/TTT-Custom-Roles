...
CreateConVar("ttt_shop_random_percent", "50", FCVAR_ARCHIVE + FCVAR_REPLICATED, "The percent chance that a weapon in the shop will be shown", 0, 100)
...
CreateConVar("ttt_killer_vision_enable", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED)
...
CreateConVar("ttt_zombie_vision_enable", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED)
...
CreateConVar("ttt_jester_notify_mode", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED, "The logic to use when notifying players that the Jester is killed", 0, 4)
...
CreateConVar("ttt_swapper_notify_mode", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED, "The logic to use when notifying players that the Swapper is killed", 0, 4)

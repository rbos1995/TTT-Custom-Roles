...
function ScoreEvent(e, scores)
    ...
    elseif e.id == EVENT_BODYFOUND then
        ...
        if scores[sid] == nil or (scores[sid].was_traitor or scores[sid].was_assassin or scores[sid].was_hypnotist or scores[sid].was_vampire or scores[sid].was_zombie or scores[sid].was_killer) then return end
